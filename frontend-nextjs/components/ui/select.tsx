...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ref={ref}
        className={cn(
            'flex h-11 w-full items-center justify-between rounded-xl border border-dark-border bg-dark-elevated px-4 py-2 text-sm text-text-primary',
...
>(({ className, children, position = 'popper', ...props }, ref) => (
    <SelectPrimitive.Portal>
        <SelectPrimitive.Content
            ref={ref}
            className={cn(
                'relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-xl border border-dark-border bg-dark-card text-text-primary shadow-lg',
...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Item
        ...
        className={cn(
            ...
            'focus:bg-dark-hover focus:text-accent-cyan',
